#include "ass6_17CS10014_17CS30001_translator.h"
...
void quads::print_quad()
{
	...
	if(ADD<=op && op<=BW_XOR)
	{
		...
		switch(op)
		{
			...
			case GTE: cout<<">="<< endl; 
			break;
            case LOG_AND: cout<<"&&"<< endl; 
			break;
            case LOG_OR: cout<<"||"<< endl; 
			break;
            case BW_XOR: cout<<"^"<< endl; 
			break;
            case BW_AND: cout<<"&"<< endl; 
			break;
            case BW_OR: cout<<"|"<< endl;
			break;
            case EQ: cout<<"=="<< endl; 
			break;
            case NEQ: cout<<"!="<< endl; 
	...
	else if(BW_U_NOT <= op && op<=ASSIGN)
	{
		...
		switch(op)
		{
            ...
            case U_NEG : cout<<"!"<< endl; 
			break;
            case ASSIGN : cout<<""<< endl; 
			break;
			case REFERENCE : cout <<"&"<< endl;
			break;
			case U_MINUS : cout<<"-"<< endl;
			break; 
            case U_PLUS : cout<<"+"<< endl; 
			break;
            case BW_U_NOT : cout<<"~"<< endl; 
			break;
			case DEREFERENCE : cout <<"*"<< endl;
		}
		cout << arg1 << endl;
	}
	else if(op==GOTO)
	...
	else if(GOTO_EQ<=op && op<=IF_FALSE_GOTO)
	{
		...
		switch(op)
		{
			case   GOTO_LT : cout<<"< "<< endl;
			break;
            case   GOTO_GT : cout<<"> "<< endl; 
            break;
            case   IF_FALSE_GOTO : cout<<"== 0"<< endl; 
            break;
            case   GOTO_GTE : cout<<">= "<< endl; 
            break;
            case   GOTO_LTE : cout<<"<= "<< endl; 
            break;
            case   GOTO_NEQ : cout<<"!= "<< endl; 
            break;
            case   IF_GOTO : cout<<"!= 0"<< endl; 
            break;
            case   GOTO_EQ : cout<<"== "<< endl; 
            break;
